      ...
      <div className="flex flex-col gap-4 max-w-md">
        ...
        <div className="flex flex-wrap items-center gap-4">
          <a href="https://react.dev/" title="React.js">
            <img src={reactjs} className="size-11 object-contain" />
          </a>

          <a href="https://www.typescriptlang.org/" title="TypeScript">
            <img src={typescript} className="size-11 object-contain" />
          </a>

          <a href="https://go.dev/" title="Go Lang">
            <img src={go} className="size-11 object-contain" />
          </a>

          <a href="https://reactnative.dev/" title="React Native">
            <img src={reactnative} className="w-[80px] object-contain" />
          </a>

          <a href="https://electronjs.org/" title="Electron.js">
            <img src={electron} className="size-11 object-contain" />
          </a>

          <a href="https://nodejs.org" title="Node.js">
            <img src={nodejs} className="size-11 object-contain" />
          </a>

          <a href="https://graphql.org/" title="GraphQL">
            <img src={graphql} className="size-11 object-contain" />
          </a>

          <a href="https://serverless.com/" title="Serverless">
            <img src={serverless} className="size-11 object-contain" />
          </a>

          <a href="https://www.mongodb.com/" title="Mongo DB">
            <img src={mongodb} className="size-11 object-contain" />
          </a>

          <a href="https://www.mysql.com/" title="MySQL">
            <img src={mysql} className="size-11 object-contain" />
          </a>

          <a href="https://aws.amazon.com/" title="Amazon Web Services">
            <img src={aws} className="size-11 object-contain" />
          </a>
        </div>
